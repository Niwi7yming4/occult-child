          ...
          <div className="relative z-10 p-6 flex flex-col items-center">
            ...
            {investigationResult.relicName && (
              <div className="w-full text-center py-3 mb-3 rounded-sm"
                ...
                <div className="font-serif text-[10px] text-[#5BA87A]/60 tracking-wider mb-1">獲得奇物</div>
                <div className="font-serif font-bold text-sm text-[#5BA87A]">〖{investigationResult.relicName}〗</div>
              </div>
            )}
